          ...
          <div className="flex flex-col">
            <div className="w-full bg-white shadow rounded-sm border border-gray-200 mb-10">
              ...
              <header className="px-5 py-4 border-b border-gray-100">
                ...
                <h2 className="font-semibold text-gray-800">Collection Number: {preparation.collectionNumber}</h2>
                <h2 className="font-semibold text-gray-800">Commodity: {preparation.commodity}</h2>
                <h2 className="font-semibold text-gray-800">Customer: {preparation.customer}</h2>
                <h2 className="font-semibold text-gray-800">Preparation Models:</h2>
                      ...
                      <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                        <tr>
                          <th className="p-2 whitespace-nowrap">
                            <div className="font-semibold text-left">qrcode</div>
                          </th>
                          <th className="p-2 whitespace-nowrap">
